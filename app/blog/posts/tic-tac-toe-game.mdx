...
The `Move` class represents a single action taken by a player during the game. One of the primary 
reasons for introducing the `Move` class is to support undo functionality.
