...
We can cache the results of each recursive call to ensure that every subproblem is solved only once. 
...
Cache the results of each recursive call in an array. Whenever the same subset of houses are encountred again, 
