...
Explore all possible combinations of non-adjacent houses and return the maximum amount 
among them.
...
### Approach 1: Explore All Possible Combinations
...
check why the below steps are not better?
