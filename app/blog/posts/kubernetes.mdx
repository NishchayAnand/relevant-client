---
title: 'System Design (Amazon EKS): Container Orchestration System'
...
2. `etcd`: Key-value store for storing the state of the cluster.
...
1. `kubectl get nodes`: get the details of the nodes in the cluster.

2. `kubectl get nodes -o wide`: get operating system details of the nodes.
